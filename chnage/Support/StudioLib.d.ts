// Lens Studio Version: 4.43.0
// Snapchat Version: 12.26
...
/**
* @description Load a JavaScript module. Used for importing another JavaScript file found in the Resources panel to be used in the current script. Similar to `require` found in CommonJS specification.
*/
declare function require(moduleName: (ScriptAsset | string)): Object
...
interface LocationCloudStorageOptions extends ScriptObject {
    ...
    * @description Event raised on discovery of nearby cloud stores. Lens developer may or may not subscribe to the event depending on their usecase.
...
/**
* @description Instance of location cloud store which has similar interfaces as cloud store.
*/
interface LocationCloudStore extends ScriptObject {
    /**
    * @description Gets a value associated with a particular location context from the persistence backend. Note: scope and collection must match that which was used when the value was originally saved.
    */
    ...
    /**
    * @description Create/update a value associated with a particular location context from the persistence backend. Note: scope and collection must match that which was used when the value was originally saved.
    */
    setValue(key: string, value: (mat4 | mat3 | mat2 | vec4 | vec2 | vec3 | boolean | quat | number | string), writeOptions: CloudStorageWriteOptions, onSaved: () => void, onError: (code: string, description: string) => void): void

    /**
    * @description Delete value associated with a particular location context from the persistence backend. Note: scope and collection must match that which was used when the value was originally saved.
    */
    deleteValue(key: string, readOptions: CloudStorageReadOptions, onDeleted: () => void, onError: (code: string, description: string) => void): void

    /**
    * @description List values associated with a particular location context from the persistence backend. Note: scope and collection must match that which was used when the value was originally saved.
    */
...
interface MultiplayerSession extends ScriptObject {
    ...
    */
    getRealtimeStoreInfo(UNKNOWNNAME: GeneralDataStore): ConnectedLensModule.RealtimeStoreCreationInfo
...
declare namespace Physics {
    /**
    * @description Exposes settings that apply to a physics world.
    */
...
declare namespace Physics {
    namespace WorldSettingsAsset {
        ...
        * @description Create an instance with default settings.
        */
        export function create(): WorldSettingsAsset
...
declare namespace Studio {
    ...
    */
    export function log(message: Object): void
...
declare namespace TensorMath {
    ...
    */
    export function mulMatToPoints(pointsTensor: Float32Array, pointsShape: vec3, matrixoutTensor: mat4, UNKNOWNNAME: Float32Array): void

    /**
    * @description Project 3D points into 2D space using an efficient batch operation.
    */
    export function projectPoints(pointsTensor: Float32Array, pointsShape: vec3, projectionMatrixoutTensor: mat4, UNKNOWNNAME: Float32Array): void
...
interface VideoTextureProvider extends TextureProvider {
    ...
    */
    ...
    /**
    * @description The playback rate of the video. Defaults to 1.
    */
    playbackRate: number
